...
function setupCalendar() {
  if (isMobile()) {
    ...
    if (calendarWidget) {
      calendarWidget.src = "https://teamup.com/kshn1rcuawwcj2uczf?view=l&showHeader=1&showLogo=1&showSearch=1&showProfileAndInfo=0&showSidepanel=1&showViewHeader=1&showAgendaDetails=0&showDateControls=1&showDateRange=1";
    }
  }
}
