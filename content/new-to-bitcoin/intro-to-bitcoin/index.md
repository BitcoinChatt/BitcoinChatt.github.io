...
<img class="mobile-banner" src="./Bitcoin Prehistory.png" style="width:40dvw;display:block;margin:0 auto;">
...
<img class="mobile-banner" src="./Genesis Block.png" style="width:40dvw;display:block;margin:0 auto;">
...
<img class="mobile-banner" src="./Moved on to Other Things.png" style="width:40dvw;display:block;margin:0 auto;">
...
<img class="mobile-banner" src="./Satoshis.png" style="width:40dvw;display:block;margin:0 auto;">
...
<img class="mobile-banner" src="./Stone Ledger to Bitcoin.png" style="width:40dvw;display:block;margin:0 auto;">
...
<img class="mobile-banner" src="./Bitcoin Issuance Schedule.png" style="width:40dvw;display:block;margin:0 auto;">
...
<img class="mobile-banner" src="./Halvings.png" style="width:40dvw;display:block;margin:0 auto;">
...
Noncustodial wallets, on the other hand, allow you to have exclusive authority over the private keys, which preserves your financial autonomy while also demanding greater responsibility. With most noncustodial wallets, the private key is 12 or 24 common English words, chosen at random from <a target="_blank" href="https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt">this list</a>. This seed phrase enables users to restore access to their funds if they lose access to their device, but it also grants control over all your bitcoin if someone else finds it. For all intents and purposes, <b>your private key <i>is</i> your bitcoin</b>, so it’s <i>imperative</i> that you learn how to protect it against water, fire, theft, loss, or anything else.

<br>

<img class="mobile-banner" src="./Wallets.png" style="width:40dvw;display:block;margin:0 auto;">
...
<img class="mobile-banner" src="./Transactions.png" style="width:40dvw;display:block;margin:0 auto;">
...
<img class="mobile-banner" src="./Lightning Network.gif" style="width:40dvw;display:block;margin:0 auto;">
...
<img class="mobile-banner" src="./Lightning.png" style="width:40dvw;display:block;margin:0 auto;">
